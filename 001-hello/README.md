...
> --gas-wanted "500000" --pkgpath gno.land/r/moul_basics_hello_v1  \
> --func Hello
```
...
```sh
gnokey maketx addpkg "MYWALLET" --deposit "1ugnot" --gas-fee "1ugnot" --gas-wanted "5000000" --broadcast "true" --remote "localhost:26657" --chainid "dev" --pkgpath "gno.land/r/moul_basics_hello_v1" --pkgdir "."
```
